...
INSTALLER=$SCRIPT_DIR/debian-buster-10.12-mipsel.tar.gz
...
[ -f debian-buster-mipsel_clean.tgz ] || wget http://ndm.zyxmon.org/binaries/debian/debian-buster-mipsel_clean.tgz
[ -f debian-buster-mipsel_clean.tgz ]
