...
INSTALLER=$SCRIPT_DIR/debian-bullseye-11.11-mipsel.tar.gz
...
[ -f debian-bullseye-mipsel_clean.tgz ] || wget http://ndm.zyxmon.org/binaries/debian/debian-bullseye-mipsel_clean.tgz
[ -f debian-bullseye-mipsel_clean.tgz ]
sudo tar -xz -C $ROOT_DIR/opt -f debian-bullseye-mipsel_clean.tgz
