...
INSTALLER=$SCRIPT_DIR/debian-trixie-13.6-aarch64.tar.gz
...
[ -f debian-trixie-arm64_clean.tgz ] || wget http://ndm.zyxmon.org/binaries/debian/debian-trixie-arm64_clean.tgz
[ -f debian-trixie-arm64_clean.tgz ]
sudo tar -xz -C $ROOT_DIR/opt -f debian-trixie-arm64_clean.tgz
...
#deb http://ftp.debian.org/debian/ trixie main non-free contrib
#deb-src http://ftp.debian.org/debian/ trixie main non-free contrib
#EOF
