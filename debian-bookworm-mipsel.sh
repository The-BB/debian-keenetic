...
INSTALLER=$SCRIPT_DIR/debian-bookworm-12.11-mipsel.tar.gz
...
[ -f debian-bookworm-mipsel_clean.tgz ] || wget http://ndm.zyxmon.org/binaries/debian/debian-bookworm-mipsel_clean.tgz
[ -f debian-bookworm-mipsel_clean.tgz ]
sudo tar -xz -C $ROOT_DIR/opt -f debian-bookworm-mipsel_clean.tgz
