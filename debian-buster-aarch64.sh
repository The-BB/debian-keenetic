...
INSTALLER=$SCRIPT_DIR/debian-buster-10.11-aarch64.tar.gz
...
[ -f debian-buster-arm64_clean.tgz ] || wget http://ndm.zyxmon.org/binaries/debian/debian-buster-arm64_clean.tgz
[ -f debian-buster-arm64_clean.tgz ]
sudo tar -xz -C $ROOT_DIR/opt -f debian-buster-arm64_clean.tgz
